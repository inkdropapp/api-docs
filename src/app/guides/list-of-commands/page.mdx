...
### editor:copy-line-up {{ selector: '.mde-cm-wrapper' }}

Duplicates the selected lines upward, keeping the selection in the top copy.

### editor:copy-line-down {{ selector: '.mde-cm-wrapper' }}
...
### editor:trigger-nes {{ selector: '.mde-cm-wrapper' }}
...
### editor:accept-nes {{ selector: '.mde-cm-wrapper' }}
...
### editor:dismiss-nes {{ selector: '.mde-cm-wrapper' }}
...
### editor:go-matching-bracket {{ selector: '.mde-cm-wrapper' }}
...
### editor:go-subword-left {{ selector: '.mde-cm-wrapper' }}

Moves the cursor one group or camel-case subword backward.

### editor:go-subword-right {{ selector: '.mde-cm-wrapper' }}
...
### editor:select-subword-left {{ selector: '.mde-cm-wrapper' }}

Moves the selection head one group or camel-case subword backward.

### editor:select-subword-right {{ selector: '.mde-cm-wrapper' }}
...
### editor:select-line {{ selector: '.mde-cm-wrapper' }}

Expands the selection to cover entire lines.

### editor:select-parent-syntax {{ selector: '.mde-cm-wrapper' }}

Expands the selection to the next larger syntactic construct.

### editor:select-matching-bracket {{ selector: '.mde-cm-wrapper' }}

Extends the selection to the bracket matching the one the selection head is on.

### editor:select-next-occurrence {{ selector: '.mde-cm-wrapper' }}
...
### editor:select-selection-matches {{ selector: '.mde-cm-wrapper' }}
...
### editor:insert-blank-line {{ selector: '.mde-cm-wrapper' }}
...
### editor:resize-image-auto {{ selector: '.mde-cm-wrapper' }}
...
### editor:resize-image-small {{ selector: '.mde-cm-wrapper' }}

Resizes the image at the cursor to 30% width.

### editor:resize-image-half {{ selector: '.mde-cm-wrapper' }}

Resizes the image at the cursor to 50% width.

### editor:resize-image-full {{ selector: '.mde-cm-wrapper' }}
...
### editor:toggle-comment {{ selector: '.mde-cm-wrapper' }}
...
### editor:toggle-line-comment {{ selector: '.mde-cm-wrapper' }}
