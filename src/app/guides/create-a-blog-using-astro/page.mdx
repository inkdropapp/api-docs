export const metadata = {
  ...
  description: 'How to create a blog using Astro'
}
...
To solve that, we've created [live-export](https://github.com/inkdropapp/live-export), which allows you to export notes 'programmatically' to your local filesystem.
...
<video controls playsInline muted>
  <source
    src="https://site-cdn.inkdrop.app/docs/manual/integrating-with-an-astro-site-export_demo.m4v"
    type="video/mp4"
  />
</video>
...
How does it work?
live-export is not a plugin of Inkdrop. Instead, it runs separately in the terminal, accessing to your data via [the local Inkdrop server](/guides/integrate-with-external-programs).
...
As I mentioned above, live-export accesses your data via [the local Inkdrop server](/guides/integrate-with-external-programs).
So, you first have to enable it and set up the authentication credentials, as described in that guide.
...
Next, create a `.env` file in the project root directory, using the credentials you set up for the local server:
...
![Install dev-tools](/images/integrating-with-an-astro-site_dev-tools.png)

After installing it, you can quickly copy notebook IDs from the context menu like so:

![copy-notebook-id](/images/integrating-with-an-astro-site_copy-notebook-id.png)
...
You've got the blog running on `http://localhost:4321/` like so:

![dev-server](/images/integrating-with-an-astro-site_dev-server.png)

Let's create a note in the notebook for the blog.

![example-post](/images/integrating-with-an-astro-site_example-post.png)
...
![new-post.png](/images/integrating-with-an-astro-site_new-post.png)
Click the post:

![post page](/images/integrating-with-an-astro-site_post-page.png)
...
![post with image](/images/integrating-with-an-astro-site_post-with-image.png)
...
![post list with thumbnail](/images/integrating-with-an-astro-site_post-list-with-thumbnail.png)
...
![add a tag](/images/integrating-with-an-astro-site_add-a-tag.png)
After adding a tag to the note, you should see there are the tags listed at `http://localhost:4321/tags`.

![tags page](/images/integrating-with-an-astro-site_tags-page.png)
