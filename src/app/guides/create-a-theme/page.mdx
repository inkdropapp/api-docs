...
9. Run `dev-server` to start the development server
10. Open the URL displayed in your console in a web browser
11. Edit your theme's `styles/theme.css` file to customize the theme
12. Run `generate-palette` to generate a `palette.json` file
13. Commit the generated `palette.json` file to your repository
14. Publish your theme
