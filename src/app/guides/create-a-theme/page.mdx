...
Select the menu _Inkdrop > Preferences_ on macOS or _File > Settings_ on Windows and Linux, click the _General_ tab on the left hand navigation, and check the "_Development Mode_", then reload the app by pressing <kbd>Alt+Cmd+Shift+R</kbd> / <kbd>Alt+Shift+R</kbd>
...
6. Reload Inkdrop using <kbd>Alt+Cmd+Shift+R</kbd> / <kbd>Alt+Shift+R</kbd>
...
7. Reload Inkdrop using <kbd>Alt+Cmd+Shift+R</kbd> / <kbd>Alt+Shift+R</kbd>
