...
Available as `env.layouts` on the [Environment](/modules/environment) passed to `activate(env)`.
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    env.layouts.insertComponentToLayoutBefore(
      'modal',
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    env.layouts.insertComponentToLayoutAfter(
      'modal',
      'MyDialog',
      'MySecondDialog'
    )
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    env.layouts.getLayoutComponents('modal')
    ```
    </CodeGroup>
  </Col>
</Row>
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    env.layouts.indexOfComponentInLayout('modal', 'MyDialog')
    ```
    </CodeGroup>
  </Col>
</Row>
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    env.layouts.setLayout('modal', ['MyDialog'])
    ```
    </CodeGroup>
  </Col>
</Row>
