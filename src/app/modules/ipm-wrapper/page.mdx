export const metadata = {
  title: 'IPM Wrapper',
  description: 'This page details how to use the IPM Wrapper for managing plugin installations in Inkdrop.',
}

# IPM Wrapper

IPM (Inkdrop Package Manager) wrapper for installing, updating, and uninstalling plugins. An instance of this class is always available as the `inkdrop.ipm` global.{{ className: 'lead' }}

While [Package Manager](/modules/package-manager) coordinates the lifecycle of installed packages, IPM wrapper facilitates invoking [the internal ipm command](https://github.com/inkdropapp/ipm) to manage packages.

---

## Install Packages {{ label: '::install(pack)' }}

Install plugins into Inkdrop.

<Row>
  <Col>
    ### Parameters
    <Properties>
      <Property name="pack" type="object" required>
        The package object with the following keys:

        <Properties sub title="pack object">
          ...
          <Property name="theme" type="boolean">
            Indicates if the package is a theme.
          </Property>
        </Properties>
      </Property>
    </Properties>
    ...
    ### Returns
    A [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) that resolves upon successful installation or rejects if the installation fails.
  </Col>
  <Col sticky>
    <CodeGroup title="Installation Example">
    ```js
...
## Update Packages {{ label: '::update(pack, newVersion)' }}

Update installed plugins to new versions.
...
<Row>
  <Col>
    ...
    <Properties>
      ...
      <Property name="newVersion" type="string" required>
        The new version to update to.
      </Property>
    </Properties>

    ### Returns
    A [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) that resolves upon successful update or rejects if the update fails.
  </Col>
  <Col sticky>
    <CodeGroup title="Update Example">
    ```js
...
## Uninstall Packages {{ label: '::uninstall(pack)' }}

Remove installed plugins from Inkdrop.
...
<Row>
  <Col>
    ...
    <Properties>
      <Property name="pack" type="object" required>
        The package object with the following key:
    ...
    ### Returns
    A [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) that resolves upon successful uninstallation or rejects if the uninstallation fails.
  </Col>
  <Col sticky>
    <CodeGroup title="Uninstallation Example">
    ```js
...
## Get Installed Packages {{ label: '::getInstalled()' }}
...
<Row>
  <Col>
    ### Returns
    A [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) that resolves with the details of installed packages or rejects if unable to retrieve this information.
  </Col>
  <Col sticky>
...
## Get Outdated Packages {{ label: '::getOutdated()' }}
...
<Row>
  <Col>
    ### Returns
    A [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) that resolves with details of packages having new versions, or rejects if unable to retrieve this information.
  </Col>
  <Col sticky>
    <CodeGroup title="Example Response">
    ```json
...
## Get Specific Package Information {{ label: '::getPackage(packageName)' }}

Fetch information for a specific package by name.

<Row>
  <Col>
    ### Parameters
    <Properties>
      <Property name="packageName" type="string" required>
        The name of the package for which information is sought.
      </Property>
    </Properties>

    ### Returns
    A [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) that resolves with the package's details, or rejects if unable to retrieve the information.
  </Col>
  <Col sticky>
    <CodeGroup title="Example Usage">
    ```js
    const packageInfo = await inkdrop.ipm.getPackage('vim');
    ```
    </CodeGroup>
    <CodeGroup title="Example Response">
    ```json
