...
Available as `env.markdownRenderer` on the [Environment](/modules/environment) passed to `activate(env)`.{{ className: 'lead' }}

It is also exported from the `inkdrop` module:
