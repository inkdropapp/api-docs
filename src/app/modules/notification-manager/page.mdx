...
Available as `env.notifications` on the [Environment](/modules/environment) passed to `activate(env)`.
...
<Row>
  ...
  <Col sticky>
    ...
    ```js
    env.notifications.onDidAddNotification(notification => {
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    env.notifications.onDidClearNotifications(() => {
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    const notifications = env.notifications.getNotifications()
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    const notification = env.notifications.addSuccess(
      'Success!', 
      {
        dismissable: true
      }
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    const notification = env.notifications.addInfo(
      'Info!', 
      {
        dismissable: true
      }
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    const notification = env.notifications.addWarning(
      'Warning!', 
      {
        dismissable: true
      }
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    const notification = env.notifications.addError(
      'Error!', 
      {
        dismissable: true
      }
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example">
    ```js
    const notification = env.notifications.addFatalError(
      'Fatal error!', 
      {
        dismissable: true
      }
