export const metadata = {
  title: 'Package',
  description: 'Explains how Inkdrop loads and activates a package’s main module and resources, such as stylesheets, keymaps, and menus.',
}
...
<Row>
  ...
  <Col sticky>
    ...
    ```js
    const disposable = env.packages.onDidDeactivate(() => {
...
<Row>
  ...
  <Col sticky>
    ...
    ```js
    const isPackageCompatible = env.packages.isCompatible();
