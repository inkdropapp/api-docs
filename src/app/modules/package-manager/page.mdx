...
The Package Manager in Inkdrop is responsible for the lifecycle management of packages. Available as `env.packages` on the [Environment](/modules/environment) passed to `activate(env)`.
