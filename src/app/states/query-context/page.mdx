...
<Row>
  <Col>
    <Properties>
      <Property name="mode" type="string">
        The query mode which takes one of "all", "book", "tag", "status", "template", "trash", and "search".
        ...
        ### `"template"`: Show note templates

        <Properties sub>
          <Property name="bookId" type="string">
            The templates notebook ID.
          </Property>
          <Property name="filterKeyword" type="string">
            A filter keyword to filter note list items.
          </Property>
  ...
  <Col sticky>
    ...
    ```js
    const { queryContext } = env.store.getState()
    ```
