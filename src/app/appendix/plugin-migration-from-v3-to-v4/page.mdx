export const metadata = {
  ...
  description:
    'How to migrate your plugin to support v4',
}

# Plugin Migration Guide from v3 to v4

In v4, there are some breaking changes in its APIs.
If you are a plugin author, please upgrade your plugins along with following instructions.{{ className: 'lead' }}
